...
const GenerateProductDescriptionOutputSchema = z.object({
  productDescription: z.string().describe('A compelling product description.'),
});
...
const prompt = ai.definePrompt({
  ...
  Generate a compelling and engaging product description based on the product name and key features provided.
  The description should be concise, highlighting the benefits of the product to the customer.
